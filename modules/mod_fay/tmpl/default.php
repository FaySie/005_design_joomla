...
<div class="content">
    ...
    <div class="section section2" id="section2">
        <div>
            ...
            <a href="<?php echo $section2_link ?>"><?php echo $section2_link_desc ?></a>
        </div>
    </div>
    <div class="section section3" id="section3">
        <div>
            ...
            <a href="<?php echo $section3_link ?>"><?php echo $section3_link_desc ?></a>
        </div>
    </div>
    <div class="section section4" id="section4">
        <div>
            ...
            <a href="<?php echo $section4_link ?>"><?php echo $section4_link_desc ?></a>
        </div>
    </div>
