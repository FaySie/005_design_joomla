...
namespace Slideshow\Listener\Pro;
...
class ProListener extends \JEvent
{
	...
	public function onToolbarAppendButton($context, $args = array())
	{
		...
		switch($context){
			case 'preferences' :
				...
				$args[] = 'administrator/components/com_slideshow/includes/plugins/pro' ;
				break;
		}
		*/
	}
	...
	/**
	 * Slideshow prepare content method
	...
	/**
	 * Slideshow after display title method
	...
	/**
	 * Slideshow before display content method
	 * Method is called by the view and the results are imploded and displayed in a placeholder
	 *
	 * @param   string $context The context of the content being passed to the plugin.
	 * @param   object $article The content object.  Note $article->text is also available.
	...
	/**
	 * Slideshow after display content method
	 * Method is called by the view and the results are imploded and displayed in a placeholder
	 *
	 * @param   string $context The context of the content being passed to the plugin.
	 * @param   object $article The content object.  Note $article->text is also available.
	...
	/**
	 * Slideshow before save content method
	...
	/**
	 * Slideshow after save content method
	...
	/**
	 * Slideshow before delete method.
	 *
	...
	/**
	 * Slideshow on change state method.
	 *
	 * @param   string $context The context for the content passed to the plugin.
